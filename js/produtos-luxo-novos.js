...
const OCULOS_ACESSORIOS = [1186,1187,1188,1189,1190,1191,1192,1193];
for (const [indice,id] of OCULOS_ACESSORIOS.entries()) window.PRODUTOS.push({id,nome:`Óculos masculino — Modelo ${indice+1}`,categoria:'Acessórios',marca:'Catálogo GLT',preco:149.99,tipo:'Óculos',tamanhos:['Único'],cores:['Conforme imagem'],descricao:'Óculos masculino selecionado do lote de acessórios GLT Imports.',img:`/assets/images/acessorios/oculos/${id}/0.jpg`,galeria:[`/assets/images/acessorios/oculos/${id}/0.jpg`],caracteristicas:['Curadoria GLT Imports','Acessório masculino','Disponibilidade sob consulta']});
